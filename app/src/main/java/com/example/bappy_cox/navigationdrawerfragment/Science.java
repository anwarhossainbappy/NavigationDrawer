...
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sciencedata="http://192.168.43.2/bappy/sciencedata.php";

        getsciencedata();
        return view;
    }

    private void getsciencedata() {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(sciencedata, new Response.Listener<JSONArray>() {
            @Override
