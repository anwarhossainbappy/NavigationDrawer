...
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        interntionaldata="http://192.168.43.2/bappy/internationaldata.php";
    ...
    private void getinternationaldata() {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(interntionaldata, new Response.Listener<JSONArray>() {
            @Override
