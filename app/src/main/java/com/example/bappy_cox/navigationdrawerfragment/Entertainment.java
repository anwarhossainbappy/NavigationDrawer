...
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        entertainmentdata="http://192.168.43.2/bappy/entertainmentdata.php";
    ...
    private void getentertainmentdata() {
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(entertainmentdata, new Response.Listener<JSONArray>() {
            @Override
