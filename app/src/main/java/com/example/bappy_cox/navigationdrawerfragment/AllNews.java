...
public class AllNews extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_allnews, container, false);
        ...
        alldataurl="http://192.168.43.2/bappy/news.php";
       // sportsdataurl1="http://192.168.43.2/bappy/sportsdata.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(alldataurl, new Response.Listener<JSONArray>() {
            @Override
